          ...
          <div key={item.id} className="card" style={{ cursor: 'pointer' }}>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-8">
                <button className="btn btn-sm btn-secondary" onClick={() => fetchSummary(item)}><Sparkles size={14} /> AI Tóm tắt</button>
                <button className="btn btn-sm btn-primary"><Play size={14} /> Học ngay</button>
              </div>
            </div>
          </div>
        ))}
